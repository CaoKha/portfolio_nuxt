    ...
    <div class="lg:mx-auto lg:flex lg:justify-between lg:gap-4">
      ...
      <main class="pt-24 lg:w-3/4 lg:pt-10" ref="portfolio_body">
        <section v-intersection-observer="[onIntersectionObserver, { threshold: 1, root: portfolio_body }]" id="About"
          ...
          <div
            class="sticky top-0 z-20 -mx-6 mb-4 w-screen bg-blue-500/10 px-6 py-5 backdrop-blur dark:bg-slate-900/75 md:pr-12 lg:sr-only lg:relative lg:top-auto lg:mx-auto lg:w-full lg:px-0 lg:py-0 lg:opacity-0">
